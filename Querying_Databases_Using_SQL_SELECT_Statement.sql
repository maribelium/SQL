...
-- Retrieve all data from the departments_employees table
...
--------- any employee that contains 'ar' in between the first and last letter of the name
...
--------- any employee that starts with 'Mar'
...
--------- any employee that doesn't contain 'mar' in their name
...
FROM employees
WHERE hire_date <= '1990-02-01';
--------- This will retrieve all employees who were employed on or before 1st of February, 1990.
...
SELECT COUNT(DISTINCT first_name) AS DistinctFirstNames_Count 
FROM employees;
